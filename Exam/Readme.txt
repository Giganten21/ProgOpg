...
I did all the excerise plus the extra where the time compared to the QR decompsistion is ploted in Compare.svg, and computed the determinant. All the relavent output is in Out.txt and the svg file. As I did all the excerise i think the performance is between a 9 or 10.
